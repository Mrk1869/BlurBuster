//
//  SensorDataRecorderViewController.m
//  BlurBuster
//
...
#import "SensorDataRecorderViewController.h"

@interface SensorDataRecorderViewController (){
    float _frequency;
    bool _isRunning;
    bool _readyToTake;
...
@implementation SensorDataRecorderViewController
